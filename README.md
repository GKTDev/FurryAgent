# Furry AGENT network. ELiza OS based Swarm. 

![Version](https://img.shields.io/badge/version-v0.5.0--alpha-orange)

## Overview
FurryAgent is an open-source desktop agent framework that enables AI to perceive and control your computer through computer vision and system-level interactions. Agents can:
...
Built for developers and researchers working on autonomous desktop agents, FurryAgent combines advanced computer vision, voice processing, and system control to create AI agents that can truly understand, analyze, and interact with computer interfaces.
...
```bash
# Clone repository
git clone https://github.com/AgentTankOS/FurryAgent.git
cd FurryAgent
```
...
FurryAgent comes with four pre-configured agents, each with distinct personalities and specializations. You can add new agents and customize all agents.
